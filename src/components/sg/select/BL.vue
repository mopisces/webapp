				...
				config:{
					...
					table:{
						columns : [
							...
							{field: 'width', title: '门幅', width:100 ,titleAlign: 'center', columnAlign: 'center',isResize:true},
							{field: 'paperMaterial', title: '生产纸质', width:100 , titleAlign: 'center', columnAlign: 'center', isResize:true, formatter:(rowData)=>{
							...
							{field: 'total_len', title: '总长', width:100 ,titleAlign: 'center', columnAlign: 'center',isResize:true}
						],
						height  : 0
					}
				},
