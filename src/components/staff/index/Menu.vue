			...
			return {
				config:{
					gridItem:[
						...
						{text:'订单试算',iconName:'jisuanqi',url:'/staff/calc/index',state:'#0bf147'},
						{text:'库区面积',iconName:'fangwumianji',url:'/staff/stock/deliveryArea',state:'#0bf147'},
						{text:'库存修改',iconName:'iconfontzhizuobiaozhunbduan24',url:'/staff/stock/mStockDetailR',state:'#0bf147'},
						...
						{text:'直接入库',iconName:'ruku2',url:'/staff/paper/directInStock',state:'#0bf147'},
						{text:'原纸入库',iconName:'ruku',url:'/staff/paper/doRStockIn',state:'#0bf147'},
						{text:'原纸出库',iconName:'ccgl-chukucaozuo-5',url:'/staff/paper/doStockOut',state:'#0bf147'},
						...
						{text:'用户管理',iconName:'guanwangicon31334',url:'/staff/user/manage',state:'#0bf147'},
					],
					authGrid:[],
					domian:{
