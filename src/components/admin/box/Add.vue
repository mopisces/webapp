	...
	<div>
		<el-form :model="formData" :rules="rules" ref="addForm" label-width="150px" label-position="left">
			...
			<el-form-item label="价格" prop="price">
				...
				<template v-else>
					<el-input v-model="formData.price" placeholder="请输入价格" style="width: 100px;"></el-input>&nbsp;&nbsp;元/个
				</template>
			</el-form-item>
			<el-form-item label="市场价格" prop="marketPrice">
				<el-input v-model="formData.marketPrice" placeholder="市场价格" style="width: 100px;"></el-input>&nbsp;&nbsp;&nbsp;&nbsp;元/个
			</el-form-item>
			...
			<el-form-item label="单客户限量" prop="cusMax">
				<el-input v-model="formData.cusMax" placeholder="请输入内容" style="width: 100px;"></el-input>&nbsp;个&nbsp;
			</el-form-item>
			<el-form-item label="总客户限量" prop="total">
				<el-input v-model="formData.total" placeholder="请输入内容" style="width: 100px;"></el-input>&nbsp;个&nbsp;
			</el-form-item>
